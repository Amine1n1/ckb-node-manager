...
- Add combined OpenRPC JSON generator ([#5093](https://github.com/nervosnetwork/ckb/pull/5093)) (by @eval-exec)
...
- support cargo-binstall: <https://github.com/cargo-bins/cargo-binstall/blob/main/SUPPORT.md> ([#5089](https://github.com/nervosnetwork/ckb/pull/5089)) (by @eval-exec)
...
- update Docker base image from bionic to focal for builder and runtime ([#5123](https://github.com/nervosnetwork/ckb/pull/5123)) (by @doitian)
- update bytes from 1.10.1 to 1.11.1 (RUSTSEC-2026-0007) ([#5099](https://github.com/nervosnetwork/ckb/pull/5099)) (by @Copilot)
